//module - global/screens/LoadingScreen.tsx
  ...
  return (
    <div className="w-screen h-screen bg-slate-950 text-white flex items-center justify-center">
      <div className="flex flex-col items-center">
        ...
        <p className="mt-4 text-xl text-slate-300">Loading Game Data...</p>
        <p className="text-sm text-slate-500">Creating players, clubs, and resources.</p>
      </div>
    </div>
  );
}
